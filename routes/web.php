...
Route::get('/','Frontend\IndexController@index');
    ...
    ///// MENU \\\\\
        ...
        //ALUMNI
        Route::get('Alumni',[App\Http\Controllers\Frontend\IndexController::class,'alumni'])->name('alumni.index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/')->middleware('role:Admin')->group( function (){
        ...
        //Export PDF
        Route::get('laporan-murid' ,[App\Http\Controllers\Backend\Pengguna\MuridController::class , 'exportpdf'])->name('laporan.murid');
        Route::get('laporan-bendahara' ,[App\Http\Controllers\Backend\Pengguna\BendaharaController::class , 'exportpdf'])->name('laporan.bendahara');
        Route::get('laporan-pengajar' ,[App\Http\Controllers\Backend\Pengguna\PengajarController::class , 'exportpdf'])->name('laporan.pengajar');
        Route::get('laporan-perpus' ,[App\Http\Controllers\Backend\Pengguna\PerpusController::class , 'exportpdf'])->name('laporan.perpus');
        Route::get('laporan-ppdb' ,[App\Http\Controllers\Backend\Pengguna\PPDBController::class , 'exportpdf'])->name('laporan.ppdb');
        Route::get('laporan-staf' ,[App\Http\Controllers\Backend\Pengguna\StafController::class , 'exportpdf'])->name('laporan.staf');
    });
});
