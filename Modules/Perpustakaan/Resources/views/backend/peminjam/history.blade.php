                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title">History Data Peminjam <a href=" {{route('peminjam.create')}} " class="btn btn-primary">Tambah</a><a href="{{route('laporan.history')}}" class="btn btn-danger">Export PDF</a></h4>
                                </div>
